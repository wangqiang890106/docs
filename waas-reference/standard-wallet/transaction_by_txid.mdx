---
title: Get Transaction By Txid
api: "GET /v1/custody/transaction_by_txid/"
description: Obtain the list of confirmed transactions through Transaction ID query(deposit&withdraw).
---


#### Request
<ParamField body="txid" type="String" required>Transaction ID, which can be found on the corresponding public chain</ParamField>
