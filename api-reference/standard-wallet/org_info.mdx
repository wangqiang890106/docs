...
description: Returns detailed information about the organization associated with the authenticated user's custody wallet.
---
...
<ResponseField name="minimum_deposit_threshold" type="String">Coin minimum withdrawal threshold</ResponseField>
