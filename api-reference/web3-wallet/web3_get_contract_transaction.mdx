...
description: Obtain contract transactions through ID query(deposit&withdraw) 
---
#### Request 

<ParamField body="request_id" type="String" required>request ID (Universally unique ID for each user's withdraw request and less than or equal to 120 characters)</ParamField> 
