...
title: "JavaScript"
icon: "js"
description: "If you’re working with JavaScript, the official [cobo-js-api](https://github.com/CoboCustody/cobo-js-api) package is the easiest way to use."
---
...
```
  "dependencies": {
     ...
    "cobo-custody": "https://github.com/CoboCustody/cobo-js-api/releases/download/v0.34.0/release.tgz"
  }
```
