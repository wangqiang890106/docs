...
#### Request
<ParamField body="coin" type="String" required>The coin symbol.</ParamField>
<ParamField body="address" type="String" required>A comma-separated list of addresses.</ParamField>
...
<ResponseField name="is_internal_address" type="Bool">Whether the address is an internal address.</ResponseField>
