...
#### Request
<ParamField body="coin" type="String" required>The coin type of the address.</ParamField>
<ParamField body="address" type="String" required>The address to check.</ParamField>
<ParamField body="memo" type="String">The memo associated with the address (if any).</ParamField>
